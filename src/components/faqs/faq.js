        ...
        <div className="faq-list">
          ...
          <div>
            <details title="Do I need to bring anything with me to my appointment?">
              ...
              <p className="faq-content">
                You don't need to bring anything specific. Just come as you are,
          ...
          <div>
            <details title="Can I walk in for a haircut or should I make an appointment?">
              ...
              <p className="faq-content">
                While appointments are preferred to ensure you get the time slot
                you want, walk-ins are welcome based on availability.
              </p>
            </details>
          </div>
          <div>
            <details title="What are your sanitation protocols?">
              ...
              <p className="faq-content">
                We strictly adhere to sanitation guidelines to ensure the safety
                of our customers. All equipment is thoroughly cleaned and
